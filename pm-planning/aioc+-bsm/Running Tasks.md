# Running Tasks — BSM (AIOC+ Blind Spot Monitoring)
...
|---|---|---|---|---|
| 4/4/26 | [ ] Skeleton PDP for BSM | Build skeleton PDP with problem framing, detection class scope, known risks, definition of done. Share with Gautam for parallel TDD. | 4/7/26 | Gautam, Achin |
| 4/4/26 | [~] Review PROBLEM.md on Confluence | Gautam to review BSM PROBLEM.md and provide comments on Confluence page. | 4/7/26 | Arjun |
