...
## Recommendation: V1 = "Yard/Depot Pedestrian Warning"
...
|---|---|---|---|---|---|---|---|
| **1** | **Yard/depot — workers near stopped vehicle** | Stopped (< 5 mph) | Rear or Side (1) | DNT explicit ask | High | Highest | ★★★★★ |
| **2** | **Reverse/backing — ped behind vehicle** | Reverse (< 5 mph) | Rear | DNT, construction broadly | High | High | ★★★★☆ |
| **3** | Low-speed job site maneuver | Moving (< 10 mph) | Side + Rear | DNT (extension) | Medium | Medium | ★★★☆☆ |
...
- **Validated customer signals** — DNT Innovations (construction, explicit AI ped ask); GreenWaste (waste, side-AI "must-have" to displace 3rdEye)
