# Running Tasks - AIDC+ / AI Platform
...
- **Fatigue detection** is the most important in-flight AI feature; heavy customer demand; competitive differentiator vs. Samsara (awful) and Netradyne (high false positives)
- **AI Pipeline Revamp** is the #1 P0 project; collision latency averages 3 min (incl. human review), P90 target 5.5 min; AI event latency optimization is newer focus
- Devin moving to experience side post-fatigue GA; will still support in some capacity
- Broader team announcement about Arjun's role planned for mid-April (post review cycle)
- Avinash driving collision latency well — engage/learn but don't over-index
- Nihar setting up twice-a-week syncs during ramp (scaling to weekly later)
- Meeting with Mark and Arjun on use cases already scheduled for next week
