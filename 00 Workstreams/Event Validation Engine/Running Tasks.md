...
|---|---|---|---|---|
| 3/27/26 | ~~Share EVE Doc with Nihar~~ | ~~Ping EVE doc to Nihar for feedback on stakeholders, open questions, and approach~~ ✅ Completed | 3/27/26 | Nihar Gupta, Michael Benesh |
...
| 4/4/26 | [ ] Add AI-only mode to EVE Q2 scope | Blog post announces AI-only mode week of Apr 7. Scope how AI-only works for high-precision models vs. collisions (high recall, low precision). Must be Q2 deliverable. | 4/7/26 | Nihar, Michael Benisch |
