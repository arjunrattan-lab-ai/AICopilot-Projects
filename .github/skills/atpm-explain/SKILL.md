...
- `../pm-references/prototype-design-system.md` — Read when building HTML prototype or visual output
</references>

<confluence>
Follow `../pm-references/confluence-sync.md` for Confluence space constants and sync procedure.

- **Parent page:** Explain: Tech Concepts & Architecture Reference (ID `6263504908`)
- **Page title convention:** `Explain / {concept}`
